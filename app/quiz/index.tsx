...
export default function QuizScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.bg }}>
      <ScrollView style={{ flex: 1, marginTop: useSafeAreaInsets().top }}
        contentContainerStyle={{ padding: 16, paddingBottom: 120 }}>

        {/* Header with back button and coffee icons */}
        <View style={styles.topRow}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Ionicons name="arrow-back" size={24} color={C.accentDark} />
          </TouchableOpacity>
        ...
        <View style={styles.heroHeader}>
          ...
          <Text style={styles.subtitle}>Tiny coffee quiz to match your mood</Text>
        </View>
                ...
                return (
                  <TouchableOpacity
                    ...
                    <View style={styles.optIcon}>
                      <Ionicons name="cafe-outline" size={16} color={C.accentDark} />
                    </View>
...
const styles = StyleSheet.create({
  ...
  progressRow: { flexDirection: 'row', gap: 6, marginTop: 4, marginBottom: 10, alignSelf: 'center' },
